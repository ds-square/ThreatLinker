...
class SbertSimilarity:
    def __init__(self, model_choice='mpnet', batch_size=32, initial_device='auto'):
        """
        ...
        :param batch_size: Dimensione dei batch per il processamento in batch.
        ...
        # Carica il modello SBERT sul dispositivo
    ...
    def calculate_similarity(self, sentence1, sentence2):
        """
        Calcola la similarità tra due frasi utilizzando SBERT.
    ...
    def calculate_similarity_batch(self, sentence, sentences_list):
        """
        Calcola le similarità tra una frase e una lista di frasi in batch utilizzando SBERT.
        ...
        try:
            ...
            #logger.info(f"Similarità batch calcolata con successo.")
